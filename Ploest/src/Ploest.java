...
public class Ploest {
	...
	static double SIGNIFICANT_MIN = 0.01;// threshold to calculate the minimal
	...
	public static void printHelp() {
		...
		System.out.println(
				"-m (multiple libraries)   - (optional) if this option is selected, the input will be the path to a .txt file containing all sam/bam files to be used instead of input");
		...
		System.out.println(
				"-k (k mixtures)        - (optional int)      Runs PloEst forcing k number of gaussians mixtures to fit the reads distribution");
		System.out.println(
				"-s (significant min)   - (optional double) Threshold to consider a minimum point in the gausian fit plot to be sigificant. Default 0.01");
